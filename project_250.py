...
transaction1 = blockchain.transaction("Me", "Teacher Zara", '5 ETH')
transaction1 = blockchain.transaction("Me", "Teacher Zara", '9 ETH')
...
transaction2 = blockchain.transaction("Me", "Friend", '5 ETH')
transaction2 = blockchain.transaction("Me", "Family member", '9 ETH')
